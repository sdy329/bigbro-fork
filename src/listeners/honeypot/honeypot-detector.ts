            ...
            embeds: [
              new EmbedBuilder()
                ...
                .addFields({
                  name: "Action",
                  value:
                    "If you believe this was a mistake or have regained access to your account, you are welcome to rejoin the server.",
                }),
            ],
          });
        } catch (error) {
          this.container.logger.error(
            `Failed to send direct message to user that they were removed for sending a message in the honeypot channel`,
            error,
          );
        }
